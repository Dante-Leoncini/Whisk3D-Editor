...
void Scrollable::ScrollY(int dy){
    // mouseOverScrollYpress: el drag AGARRADO sigue valiendo aunque el cursor se
    // salga unos pixeles de la barra (7px de ancho) mientras el boton siga apretado
    if (leftMouseDown && (mouseOverScrollY || mouseOverScrollYpress)) {
